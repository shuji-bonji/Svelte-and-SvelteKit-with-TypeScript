...
:::caution[addEventListenerとの順序問題]
...
:::info[MediaQueryクラスについて]
`MediaQuery`クラス自体は`svelte/reactivity`モジュールからインポートします。詳しくは[組み込みリアクティブクラス](/svelte/advanced/built-in-classes/)を参照してください。
:::
