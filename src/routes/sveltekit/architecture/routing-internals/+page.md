...
<ul>
<li><a href="{base}/sveltekit/routing/">ルーティング（基礎編）</a> - 基本的な使い方</li>
<li><a href="{base}/sveltekit/routing/dynamic/">動的ルーティング</a> - パラメータ付きルート</li>
<li><a href="{base}/sveltekit/routing/advanced/">高度なルーティング</a> - 実践的なテクニック</li>
</ul>
