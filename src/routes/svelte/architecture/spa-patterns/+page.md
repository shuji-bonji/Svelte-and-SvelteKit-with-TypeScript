  ...
  <a href="{base}/svelte/architecture/spa-patterns/firebase/" class="no-underline">
    <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-lg transition-all">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h3 class="font-bold text-xl mb-2 text-slate-600 dark:text-slate-300">Firebase統合</h3>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span class="px-2 py-1 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-xs rounded">ホスティング</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <a href="{base}/svelte/architecture/spa-patterns/supabase/" class="no-underline">
    <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-lg transition-all">
      <div class="flex items-start gap-4">
        <div class="text-4xl">⚡</div>
        <div class="flex-1">
          <h3 class="font-bold text-xl mb-2 text-slate-600 dark:text-slate-300">Supabase統合</h3>
          <p class="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span class="px-2 py-1 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-xs rounded">Edge Functions</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <a href="{base}/svelte/architecture/spa-patterns/graphql/" class="no-underline">
    <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-lg transition-all">
      <div class="flex items-start gap-4">
        <div class="text-4xl">🎯</div>
        <div class="flex-1">
          <h3 class="font-bold text-xl mb-2 text-slate-600 dark:text-slate-300">GraphQL統合</h3>
          <p class="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span class="px-2 py-1 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-xs rounded">キャッシュ</span>
          </div>
        </div>
      </div>
    </div>
