...
<Admonition type="tip" title="公式ドキュメント">

Svelte MCP の公式ドキュメントは <a href="https://svelte.dev/docs/mcp">svelte.dev/docs/mcp</a> で公開されています。
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-8 auto-rows-[1fr]">
  <a href="{base}/svelte-mcp/setup/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">各 MCP クライアントでの設定方法を解説します。</p>
  ...
  <a href="{base}/svelte-mcp/tools/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">MCP が提供する 4 つのツールを詳しく解説します。</p>
      <ul class="text-sm space-y-1 flex-grow list-disc pl-5" style="color: var(--color-card-list);">
  ...
  <a href="{base}/svelte-mcp/usecases/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      <div class="text-3xl mb-2">💡</div>
      <h3 class="font-bold text-lg mb-2" style="color: var(--color-card-title);">
        ユースケース
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">実践的な活用シナリオを紹介します。</p>
      <ul class="text-sm space-y-1 flex-grow list-disc pl-5" style="color: var(--color-card-list);">
  ...
  <a href="{base}/svelte-mcp/architecture/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      <div class="text-3xl mb-2">🏗️</div>
      <h3 class="font-bold text-lg mb-2" style="color: var(--color-card-title);">
        アーキテクチャ
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">内部アーキテクチャを詳しく解説します。</p>
      <ul class="text-sm space-y-1 flex-grow list-disc pl-5" style="color: var(--color-card-list);">
  ...
  <a href="{base}/svelte-mcp/integration/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      <div class="text-3xl mb-2">⚙️</div>
      <h3 class="font-bold text-lg mb-2" style="color: var(--color-card-title);">
        開発環境との統合
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">プロジェクトへの統合方法を解説します。</p>
      <ul class="text-sm space-y-1 flex-grow list-disc pl-5" style="color: var(--color-card-list);">
        <li>プロジェクト初期化</li>
        <li>ESLint との連携</li>
  ...
  <a href="{base}/svelte-mcp/ecosystem/" class="flex no-underline group h-full not-prose" style="color: inherit;">
    <div class="section-card p-4 cursor-pointer flex flex-col w-full">
      <div class="text-3xl mb-2">🌐</div>
      <h3 class="font-bold text-lg mb-2" style="color: var(--color-card-title);">
        エコシステム
      ...
      <p class="text-sm mb-3" style="color: var(--color-card-desc);">関連するツールとリソースを紹介します。</p>
      <ul class="text-sm space-y-1 flex-grow list-disc pl-5" style="color: var(--color-card-list);">
        <li>公式 MCP パッケージ</li>
...
<Admonition type="note" title="自動設定">
