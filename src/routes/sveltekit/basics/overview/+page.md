...
<Admonition type="info" title="詳細を学ぶ">
...
<Admonition type="tip" title="詳細な解説">
...
<details>
<summary>データフローの実装コードを見る</summary>
...
<details>
<summary>APIルートの実装コードを見る</summary>
...
export const POST: RequestHandler = async ({ request }) => {
  ...
  if (!body.title || !body.content) {
    return json({ error: 'タイトルと内容は必須です' }, { status: 400 });
  }
...
<details>
<summary>+page.svelte（フロントエンド）のコードを見る</summary>
...
<details>
<summary>1. 基本のHTML（JavaScriptなしでも動作）</summary>
...
<details>
<summary>2. CSSで見た目と使い勝手を改善</summary>
...
<details>
<summary>3. JavaScriptで強化（use:enhance）</summary>
...
<Admonition type="tip" title="開発効率">
...
<Admonition type="tip" title="SvelteKitの優位性">

<ul>
<li><strong>パフォーマンス</strong>: 最小のバンドルサイズと高速実行</li>
<li><strong>シンプルさ</strong>: 少ない記述量で多くを実現</li>
<li><strong>Web標準準拠</strong>: 標準に近いAPI設計</li>
</ul>
