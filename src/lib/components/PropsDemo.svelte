...
<div class="demo-container">
  ...
  <section class="component-section">
    ...
    <div class="button-grid">
      ...
      <Button onClick={() => handleButtonClick('primary', 'large')} size="large">
        Large Primary
      </Button>
      
      <Button variant="secondary" size="small" onClick={() => handleButtonClick('secondary', 'small')}>
        Small Secondary
      </Button>
      <Button variant="secondary" onClick={() => handleButtonClick('secondary', 'medium')}>
        Medium Secondary
      </Button>
      <Button variant="secondary" size="large" onClick={() => handleButtonClick('secondary', 'large')}>
        Large Secondary
      </Button>
      
      <Button variant="danger" size="small" onClick={() => handleButtonClick('danger', 'small')}>
        Small Danger
      </Button>
      <Button variant="danger" onClick={() => handleButtonClick('danger', 'medium')}>
        Medium Danger
      </Button>
      <Button variant="danger" size="large" onClick={() => handleButtonClick('danger', 'large')}>
        Large Danger
      </Button>
    </div>
  ...
  <section class="component-section">
    ...
    {#if showSuccessAlert}
      <Alert type="success" title="成功" dismissible onDismiss={() => showSuccessAlert = false}>
        フォームが正常に送信されました！
      </Alert>
    {/if}
