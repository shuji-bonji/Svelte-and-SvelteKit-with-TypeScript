...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
  ...
  <div class="content-card p-4">
    <h5 class="font-bold text-lg mb-3 text-slate-600 dark:text-slate-300">🎯 適している用途</h5>
    <ul class="space-y-2 text-sm">
      <li class="flex items-start">
...
Load 関数内での async/await の実行タイミングと並列処理による最適化の詳細については、[データフローの詳細](/sveltekit/data-loading/flow/)ページで解説しています。

## TypeScript 型の自動生成システム

SvelteKit の型安全なデータ取得と`./$types`の自動生成システムの詳細は、[TypeScript 型の自動生成システム](/sveltekit/data-loading/typescript-types/)の専用ページで解説しています。
...
- [TypeScript 型の自動生成システム](/sveltekit/data-loading/typescript-types/) - TypeScript 型の自動生成の仕組み
- [データフローの詳細](/sveltekit/data-loading/flow/) - Load 関数の実行順序とデータの流れ
- [データフェッチング戦略](/sveltekit/data-loading/strategies/) - 高度なデータ取得テクニック
