...
<ul>
<li>Reactの<code>useState</code>のセッター関数を子に渡すパターンに相当</li>
<li>Vueの<code>v-model</code>による双方向バインディングに相当</li>
<li>ただし、Svelteの<code>$bindable</code>はより直感的で型安全</li>
</ul>
...
let { color = $bindable('#000000'), format = 'hex' }: Props = $props();
...
let { value = $bindable(''), debounce = 300 }: Props = $props();
...
<ul>
<li><a href="/deep-dive/reactive-state-variables-vs-bindings/">$state: リアクティブな状態変数と、バインディングの違い</a> - Svelte 5の新しいリアクティビティモデルと従来のバインディングの違いを解説</li>
</ul>
