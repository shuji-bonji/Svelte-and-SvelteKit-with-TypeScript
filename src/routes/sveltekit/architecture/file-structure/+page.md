...
<ul>
<li><a href="{base}/sveltekit/basics/project-structure/">プロジェクト構造（基礎編）</a> - 基本的なディレクトリ構成</li>
<li><a href="{base}/sveltekit/basics/file-system/">特殊ファイルシステム</a> - ファイルの基本的な役割</li>
<li><a href="{base}/sveltekit/deployment/execution-environments/">実行環境とランタイム</a> - デプロイ環境の詳細</li>
</ul>
