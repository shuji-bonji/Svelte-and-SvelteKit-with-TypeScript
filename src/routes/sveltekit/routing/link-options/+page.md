...
<a data-sveltekit-preload-data="tap" href="/stocks"> 最新の株価を見る </a>
```
...
<Admonition type="warning" title="viewport と eager の制限">
...
```html
<!-- フルページリロードを強制 -->
<a data-sveltekit-reload href="/legacy-page"> レガシーページ </a>

<!-- rel="external" でも同じ効果 -->
<a rel="external" href="/external-app"> 外部アプリ </a>
```
...
```html
<!-- 履歴を増やさない -->
<a data-sveltekit-replacestate href="/step-2"> 次のステップへ </a>
```
...
<Admonition type="warning" title="アクセシビリティへの配慮">
