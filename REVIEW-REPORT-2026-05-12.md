...
15. **～~`examples/auth-jwt` 状態表記の整合~~** — **保留**。CLAUDE.md 上は「✅ 完成」だが、`shuji-bonji/svelte5-auth-jwt` リポジトリと Vercel デモが実在しないことを 2026-05-13 に確認。CLAUDE.md 側の実装例表を実態に合わせて修正することが先決。
