...
<Admonition type="warning" title="セキュリティ">
...
<Admonition type="info" title="重要な特性">
...
<Admonition type="tip" title="使い分けの原則">
<ul>
<li><strong>Layout</strong>: 複数ページで<strong>共通</strong>の処理・UI</li>
<li><strong>Page</strong>: そのページ<strong>固有</strong>の処理・コンテンツ</li>
</ul>
...
<Admonition type="info" title="重要：UIレイアウトとは異なる概念">
...
<Admonition type="warning" title="TypeError: Cannot access 'X' before initialization">
**原因**: Load関数の循環参照  
**解決**: `parent()`の呼び出しタイミングを確認
</Admonition>
<Admonition type="warning" title="Hydration mismatch">
**原因**: サーバーとクライアントで異なる内容  
**解決**: `browser`変数を使用して条件分岐
</Admonition>
<Admonition type="warning" title="500 Internal Server Error in production">
